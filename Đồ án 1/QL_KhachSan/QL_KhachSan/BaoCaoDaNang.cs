...
{
    public partial class BaoCaoDaNang : Form
    {
        ...
        private void BaoCaoDaNang_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'BaoCaoDN.HoaDon' table. You can move, or remove it, as needed.
            this.HoaDonTableAdapter.Fill(this.BaoCaoDN.HoaDon);
